...
/**
 * Manages {@link AlfredSnackbar}s.
 */
class AlfredSnackbarManager {
    ...
    private static AlfredSnackbarManager sSnackbarManager;

    static AlfredSnackbarManager getInstance() {
        if (sSnackbarManager == null) {
            sSnackbarManager = new AlfredSnackbarManager();
        }
    ...
    public void show(int duration, Callback callback) {
        synchronized (mLock) {
            ...
            if (mCurrentSnackbar != null && cancelSnackbarLocked(mCurrentSnackbar,
                    AlfredSnackbar.Callback.DISMISS_EVENT_CONSECUTIVE)) {
    ...
    private void scheduleTimeoutLocked(SnackbarRecord r) {
        if (r.duration == AlfredSnackbar.LENGTH_INDEFINITE) {
        ...
        } else if (r.duration == AlfredSnackbar.LENGTH_SHORT) {
    ...
    void handleTimeout(SnackbarRecord record) {
        synchronized (mLock) {
            if (mCurrentSnackbar == record || mNextSnackbar == record) {
                cancelSnackbarLocked(record, AlfredSnackbar.Callback.DISMISS_EVENT_TIMEOUT);
            }
        }
    }
