...
public class AlfredSnackbarContentLayout extends LinearLayout implements
        AlfredBaseTransientBottomBar.ContentViewCallback {
    ...
    public AlfredSnackbarContentLayout(Context context) {
        this(context, null);
    }

    public AlfredSnackbarContentLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
