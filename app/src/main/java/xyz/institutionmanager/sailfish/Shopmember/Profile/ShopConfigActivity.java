...
public class ShopConfigActivity extends BaseActivity implements HttpResultListener {

    private String s_id;
    private static final int REQUEST_ShopConfigQuery = 1;
    private static final int REQUEST_ShopConfigModify = 2;
    ...
    public void onRespStatus(String body, int source) {
        if (source == REQUEST_ShopConfigQuery) {
            switch (NetRespStatType.dealWithRespStat(body)) {
                case NSR:
                    ViewHandler.toastShow(ShopConfigActivity.this,Ref.OP_NSR);
                    ShopConfigActivity.this.finish();
                    break;
                case STATUS_AUTHORIZE_FAIL:
                    ViewHandler.exitAcitivityDueToAuthorizeFail(ShopConfigActivity.this);
                    break;
                default:break;
            }
        }else if (source == REQUEST_ShopConfigModify) {
            switch (NetRespStatType.dealWithRespStat(body)) {
                case NSR:
                    ViewHandler.toastShow(ShopConfigActivity.this,Ref.OP_NSR);
                    break;
                case SUCCESS:
                    ViewHandler.toastShow(ShopConfigActivity.this,Ref.OP_MODIFY_SUCCESS);
                    ShopConfigActivity.this.finish();
                    break;
                case FAIL:
                    ViewHandler.toastShow(ShopConfigActivity.this,Ref.OP_MODIFY_FAIL);
                    break;
                case STATUS_AUTHORIZE_FAIL:
                    ViewHandler.exitAcitivityDueToAuthorizeFail(ShopConfigActivity.this);
                    break;
    ...
    public void onRespMapList(String body, int source) throws IOException {
        if (source == REQUEST_ShopConfigQuery) {
            ...
            mapList = JsonUtil.strToListMap(body,key);
    ...
    public void onRespError(int source) {
        ViewHandler.toastShow(ShopConfigActivity.this,Ref.UNKNOWN_ERROR);
        if (source == REQUEST_ShopConfigQuery) {
            ShopConfigActivity.this.finish();
        }else if (source == REQUEST_ShopConfigModify) {
    ...
    public void onReqFailure(Object object, int source) {
        ViewHandler.toastShow(ShopConfigActivity.this, Ref.CANT_CONNECT_INTERNET);
    }
    ...
    private void loadData() {
        ...
        NetUtil.reqSendGet(this,url,new HttpCallback(this,this,REQUEST_ShopConfigQuery));
    }
    ...
    private void submitChange(String s) {
        ...
        NetUtil.reqSendGet(this,url,new HttpCallback(this,this,REQUEST_ShopConfigModify));
    }
}
