package xyz.institutionmanage.sailfish.Member.Book;
...
public class MBookDetailPrivateActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void initDataFromWebsite() {
        ...
        Callback callback = new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                MethodTool.showToast(MBookDetailPrivateActivity.this, Ref.CANT_CONNECT_INTERNET);
            }
                ...
                switch (EnumRespType.dealWithResponse(resp)) {
                    ...
                    case RESP_STAT:
                        switch (EnumRespStatType.dealWithRespStat(resp)) {
                            case NSR:
                                MethodTool.showToast(MBookDetailPrivateActivity.this,Ref.OP_NSR);
                                MBookDetailPrivateActivity.this.finish();
                                break;
                            case SESSION_EXPIRED:
                                MethodTool.showToast(MBookDetailPrivateActivity.this,Ref.ALERT_SESSION_EXPIRED);
                        ...
                        break;
                    case RESP_ERROR:
                        MethodTool.showToast(MBookDetailPrivateActivity.this,Ref.UNKNOWN_ERROR);
                        break;
                    default:break;
                }
            }
        };
        NetUtil.sendHttpRequest(MBookDetailPrivateActivity.this,url,callback);
    }
    ...
    private void attend() {
        ...
        Callback callback = new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                MethodTool.dealWithWebRequestFailure(MBookDetailPrivateActivity.this);
            }
                    ...
                    case RESP_STAT:
                        switch (EnumRespStatType.dealWithRespStat(resp)) {
                            case SESSION_EXPIRED:
                                ...
                                break;
                            case AUTHORIZE_FAIL:
                                MethodTool.showToast(MBookDetailPrivateActivity.this,"你尚未办理所该课程需要的会员卡，暂无法预订");
                                break;
                            case DUPLICATE:
                                MethodTool.showToast(MBookDetailPrivateActivity.this,"你已签到了该排课");
                                break;
                            case EXE_SUC:
                                MethodTool.showToast(MBookDetailPrivateActivity.this,"签到成功");
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        tv_state.setText("已签到");
                                ...
                                break;
                            case EXE_FAIL:
                                MethodTool.showToast(MBookDetailPrivateActivity.this,"签到失败");
                                break;
                            default:break;
                        }
                        break;
