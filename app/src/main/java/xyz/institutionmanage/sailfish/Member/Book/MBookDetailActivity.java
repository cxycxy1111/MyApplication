...
public class MBookDetailActivity
        extends BaseActivity
        implements MBookDetaillTeacherFragment.OnFragmentInteractionListener,
        MBookDetailInfoFragment.OnFragmentInteractionListener{
    ...
    private void initDatas(){
        ...
        fragments.add(MBookDetailInfoFragment.newInstance(cp_id));
        fragments.add(MBookDetaillTeacherFragment.newInstance(cp_id));
    }
    ...
    private void initViews() {
        ...
        adapter = new ViewPagerAdapter(getSupportFragmentManager(),new String[] {"基本信息","带课教师"},fragments);
        if (tabLayout != null) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                MBookDetailActivity.this.finish();
                break;
            default:break;
        }
        return true;
