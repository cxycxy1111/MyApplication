...
public class ChargeActivity extends BaseActivity
                ...
                switch (str_source) {
                    case "ShopmemberMainActivity":
                        switch (selected_main_type) {
                            case 0:
                                ViewHandler.toastShow(ChargeActivity.this,"无法提交");
                                break;
                            case 1:
    ...
    public void onRespStatus(String body, int source) {
        if (source == REQUEST_QueryMemberList) {
            ...
            switch (respStatType) {
                case EMPTY:
                    ViewHandler.toastShow(ChargeActivity.this,"暂无会员，请新增");
                    ChargeActivity.this.finish();
                    break;
                case STATUS_AUTHORIZE_FAIL:
                    ViewHandler.exitAcitivityDueToAuthorizeFail(ChargeActivity.this);
                    break;
                default:break;
            }
            ...
            switch (respStatType) {
                case EMPTY:
                    ViewHandler.toastShow(ChargeActivity.this,STR_NO_MEMBER_CARD);
        ...
        }else if (source == REQUEST_Charge) {
            NetRespStatType respStatType = NetRespStatType.dealWithRespStat(body);
            switch (respStatType) {
                case SUCCESS:
                    ViewHandler.toastShow(ChargeActivity.this,Ref.OP_SUCCESS);
                    ...
                    break;
                case FAIL:
                    ViewHandler.toastShow(ChargeActivity.this,Ref.OP_FAIL);
                    ChargeActivity.this.finish();
                    break;
                case NSR:
                    ViewHandler.toastShow(ChargeActivity.this,Ref.STAT_NSR);
                    ChargeActivity.this.finish();
                    break;
                case STATUS_NOT_MATCH:
                    ViewHandler.toastShow(ChargeActivity.this,Ref.STATUS_NOT_MATCH);
                    ChargeActivity.this.finish();
                    break;
                case STATUS_AUTHORIZE_FAIL:
                    ViewHandler.exitAcitivityDueToAuthorizeFail(ChargeActivity.this);
    ...
    public void onRespError(int source) {
        ViewHandler.toastShow(ChargeActivity.this,Ref.UNKNOWN_ERROR);
    }

    @Override
    public void onReqFailure(Object object, int source) {
        ViewHandler.toastShow(ChargeActivity.this, Ref.CANT_CONNECT_INTERNET);
    }
    ...
    private void initViews() {
        et_balance = (EditText)findViewById(R.id.et_balance_a_charge);
        et_num = (EditText)findViewById(R.id.et_num_a_charge);
        et_invalid_time = (EditText)findViewById(R.id.et_time_a_charge);
    ...
    private void initDatePickerDialog() {
        ...
        datePickerDialog = new DatePickerDialog(ChargeActivity.this,
                listener,
    ...
    private void submitBalanceCharge(String num) {
        ...
        HttpCallback callback = new HttpCallback(this,this,REQUEST_Charge);
        NetUtil.reqSendGet(this,url,callback);
    }
