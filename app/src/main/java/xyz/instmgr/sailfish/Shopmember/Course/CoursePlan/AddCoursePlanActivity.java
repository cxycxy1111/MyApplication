...
public class AddCoursePlanActivity
    ...
    private String selected_course,selected_teacher,selected_classroom,selected_course_type,current_courseplan;
...
//        sp_teacher = (Spinner)findViewById(R.id.sp_tea_add_new_courseplan);
    ...
    public void onRespMapList(String body, int source) throws IOException {
        if (source == REQ_LOAD_CLASSROOM) {
            ...
            String[] strs_keys = new String[]{"id"};
            map = JsonUtil.strToListMap(body,strs_keys).get(0);
            current_courseplan = String.valueOf(map.get(Ref.ID));
