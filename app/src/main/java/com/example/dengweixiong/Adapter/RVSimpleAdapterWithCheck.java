...
public class RVSimpleAdapterWithCheck extends RecyclerView.Adapter implements View.OnClickListener{
    ...
    public void setOnItemClickListener(RVSimpleAdapter.OnItemClickListener onItemClickListener) {
